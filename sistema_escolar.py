...
while acessoLista != "n":
    ...
    match escolha:
        case 1:
            print(str("Nomes:"), (listaNomes))
        case 2:
            print(str("Idades:"), (listaIdades))
        case 3:
            print(str("CPF"), (listaCpf))
        case 4:
            print(str("Mães: "), listaFiliacaoMae)
            print(str("Pais: "), listaFiliacaoPai)
        case 5:
            print(str("Rendas:"), (listaRenda))
        case 6:
            print(str("Bolsas 100%: "), listaBolsa100)
            print(str("Bolsas 50%: "), listaBolsa50)
            print(str("Bolsas 30%: "), listaBolsa30)
        case 7:
            print(str("Maternais: "), listaMaternal)
            print(str("Ensino fundamental: "), listaFundamental)
            print(str("Ensino médio: "), listaMedio)
